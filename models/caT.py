...
class caT(ModelMixin, ConfigMixin):
    r"""
    ...
    def __init__(
        ...
        self.conditioning_in = caTConditioningTransformerModel(
    ...
    def forward(
        ...
        return caTOutput(sample=sample)
    ...
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None):
        ...
        if not os.path.isfile(model_file):
            raise FileNotFoundError(f"{model_file} not found. Ensure the file exists.")
